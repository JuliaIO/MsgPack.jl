...
# fixext 2
@test ck_pack(Ext(-32, [0x56, 0x8d], apptype=false), [0xd5, 0xe0, 0x56, 0x8d])
# fixext 4
@test ck_pack(Ext(-123, [0x80, 0x7c, 0x8b, 0xf8], apptype=false),
...
# no elements
@test ck_pack(Ext(-118, Uint8[], apptype=false), [0xc7, 0x00, 0x8a])
# ext 8
...
# ext 32
b = rand(Uint8, 2^19)
@test ck_pack(Ext(-123, b, apptype=false),
